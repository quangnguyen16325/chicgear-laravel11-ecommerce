<div>
    <main class="main">
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span><a href="{{ route('admin.order') }}">Quản lý đơn hàng</a> 
        ...
        <div class="container mt-5 mb-5">
            <div class="mb-3">
                <a href="{{ route('admin.order') }}" class="text-muted small hover-link"><< Quay lại danh sách đơn hàng</a>
            </div>
            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <p>
                                    ...
                                    @elseif($order->status == 'delivered')
                                        Đã giao hàng (Đợi xác nhận từ khách hàng)
