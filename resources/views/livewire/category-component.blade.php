                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Đã tìm thấy <strong class="text-brand">{{ $products->total() }}</strong> mặt hàng dành cho bạn từ Danh mục <strong class="text-brand">{{ $category_name }}</strong>!</p>
                            </div>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy == 'Giá: Thấp đến Cao' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Giá: Thấp đến Cao')">Giá: Thấp đến Cao</a></li>
                                            <li><a class="{{ $orderBy == 'Giá: Cao đến Thấp' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Giá: Cao đến Thấp')">Giá: Cao đến Thấp</a></li>
                                            <li><a class="{{ $orderBy == 'Mới nhất' ? 'active': '' }}" href="#" wire:click.prevent="changeOrderBy('Mới nhất')">Mới nhất</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">{{ number_format($nproduct->regular_price, 0, '', '.') }}đ</p>
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <h4>Giảm 17% cho <br>Đầm Văn Phòng</h4>
