                ...
                <div class="container">
                    <div class="row product-grid-4">
                        @if (Cart::instance('wishlist')->count() > 0)
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-price">
                                                <span>{{ number_format($item->model->regular_price, 0, '', '.') }}đ </span>
                                                {{-- <span class="old-price">$245.8</span> --}}
                                            </div>
                                            <div class="product-action-1 show">
                                                    <a aria-label="Xóa khỏi Yêu thích" class="action-btn hover-up wishlisted" href="#" wire:click.prevent="removeFromWishlist({{ $item->model->id }})"><i class="fi-rs-heart"></i></a>
                            ...
                            @endforeach
                        @else
                        <p>Bạn chưa thêm sản phẩm yêu thích nào. <a href="{{ route('shop') }}">Khám phá các sản phẩm khác</a> và thêm vào yêu thích nhé!</p>
                        @endif
                    </div>
                </div>
            </section>
